---
name: coherence
description: Coherence guardrails system — init wizard, architecture review, drift detection, test runner, hook inspector, spec reporter, config viewer, status, and uninstall.
user_invocable: true
...
List all `.cjs` and `.js` files in `.claude/hooks/`.
